...
| **Industrial camera USB3 → host**                            |                                     **~1–4 ms** |   **low to moderate** | Very fast and direct, but shorter cable range and host dependency. **Note:** not ideal for multi-stereo setups with 2–5 cameras, as USB3 typically introduces more interrupt scheduling overhead than Ethernet       |
